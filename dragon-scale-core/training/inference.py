"""
SageMaker inference entry point for DRAGON_SCALE threat detection model.
...
N_FEATURES = int(os.environ.get("MODEL_N_FEATURES", "50"))
...
def model_fn(model_dir: str) -> ThreatDetectorEnsemble:
    ...
    logger.info("Loading DRAGON_SCALE threat detector from %s", model_dir)
