#!/usr/bin/env bash
# =============================================================================
# DRAGON_SCALE Local Training Launcher
...
DATASET="${DRAGON_SCALE_DATASET:-cicids2018,cicids2017,unsw_nb15}"
DATA_PATH="${DRAGON_SCALE_DATA_PATH:-${SCRIPT_DIR}/datasets/data}"
OUTPUT_PATH="${DRAGON_SCALE_OUTPUT_PATH:-${REPO_ROOT}/backend/ai-engine/trained_models}"
DEVICE="${DRAGON_SCALE_TRAINING_DEVICE:-cpu}"
MAX_ROWS="${DRAGON_SCALE_MAX_ROWS:-}"
MODELS=""
FORCE=""
...
elif [[ -x "${REPO_ROOT}/dragon-scale-core/.venv/bin/python" ]]; then
    PYTHON="${REPO_ROOT}/dragon-scale-core/.venv/bin/python"
...
log ""
log "═══════════════════════════════════════════════"
log "  DRAGON_SCALE Training Plan"
log "═══════════════════════════════════════════════"
log "  Dataset    : ${DATASET}"
log "  Device     : ${DEVICE}"
