...
const INTEGRATION_TYPES: Record<IntegrationType, IntegrationTypeConfig> = {
  ...
  siem_splunk: {
    ...
    fields: [
      ...
      { key: "index", label: "Index", placeholder: "dragon-scale" },
    ],
  },
  siem_elastic: {
    label: "Elastic SIEM",
    fields: [
      {
        ...
        placeholder: "https://elastic:9200",
      },
      {
        key: "api_key",
        label: "API Key",
      ...
      { key: "index", label: "Index", placeholder: "dragon-scale-events" },
    ],
  },
  soar_xsoar: {
            ...
            {typeConfig.fields.map((f) => (
              <div key={f.key}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormFields({ ...formFields, [f.key]: e.target.value })
                  }
      ...
      {isLoading ? (
        ...
        <div className="card p-12 text-center space-y-3">
          ...
          <p className="text-sm text-slate-500">
            Add a SIEM, SOAR, or ticketing integration to route DRAGON_SCALE alerts
            externally.
          </p>
        </div>
      ) : (
                ...
                <div className="mt-3 pt-3 border-t border-slate-700">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {integ.config_keys.map((k) => (
                      <span
                        key={k}
                        className="badge bg-slate-700/50 text-slate-300 border border-slate-600/50"
                      >
                        {k}
                      </span>
                    ))}
