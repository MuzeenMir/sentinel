#!/usr/bin/env python3
"""
DRAGON_SCALE MCP Server — exposes DRAGON_SCALE API as MCP tools for Cursor/LLMs.

Environment:
  DRAGON_SCALE_API_URL  Base URL for API gateway (default http://localhost:8080)
  DRAGON_SCALE_API_TOKEN Optional JWT for authenticated calls
"""
...
BASE_URL = os.environ.get("DRAGON_SCALE_API_URL", "http://localhost:8080").rstrip("/")
TOKEN = os.environ.get("DRAGON_SCALE_API_TOKEN", "")
...
if FastMCP is not None:
    mcp = FastMCP(
        "DRAGON_SCALE",
        description="DRAGON_SCALE security platform: threats, alerts, policies, compliance, hardening.",
    )
