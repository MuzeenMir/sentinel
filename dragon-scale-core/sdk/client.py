"""DRAGON_SCALE Python SDK client.

Provides a high-level interface to the DRAGON_SCALE API gateway.  Handles
...
Usage::
    ...
    with DragonScaleClient("https://dragon-scale.example.com", username="admin", password="s3cret") as client:
        client.authenticate()
...
logger = logging.getLogger("dragon-scale-sdk")
...
class DragonScaleClient:
    """Thread-safe client for the DRAGON_SCALE REST API."""
    ...
    def __enter__(self) -> DragonScaleClient:
        return self
