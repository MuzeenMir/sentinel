"""Custom detector interface for the DRAGON_SCALE SDK.
...
from sdk.exceptions import APIError, DragonScaleError, ValidationError
...
class BaseCustomDetector(ABC):
    ...
    def register(self, client: DragonScaleClient) -> bool:
        """Register this detector with the DRAGON_SCALE AI engine.
