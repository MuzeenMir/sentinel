"""
Base class for DRAGON_SCALE stream processing jobs.
...
class BaseStreamJob(ABC):
    """
    Abstract base for all DRAGON_SCALE Kafka stream processing jobs.
    ...
    def create_consumer(
        ...
        config = {
            ...
            "group.id": group_id or f"dragon-scale-{self.job_name}",
