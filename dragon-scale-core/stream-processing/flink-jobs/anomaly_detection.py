"""
DRAGON_SCALE Anomaly Detection Stream Job
...
class AnomalyDetectionJob(BaseStreamJob):
    def __init__(self):
        ...
        self.alerts_topic = "dragon-scale-alerts"
        self.detections_topic = "dragon-scale-detections"
    ...
    def setup(self):
        self.create_consumer(
            ...
            group_id="dragon-scale-anomaly-detection",
        )
