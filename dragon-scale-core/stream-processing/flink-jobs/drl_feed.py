"""
DRAGON_SCALE DRL Feed Stream Job
...
INPUT_TOPICS = [
    "dragon-scale-network-events",
    "extracted_features",
    "dragon-scale-detections",
    "dragon-scale-alerts",
]
...
class DRLFeedJob(BaseStreamJob):
        ...
        self._session.headers.update(
            {
                ...
                "User-Agent": "dragon-scale-drl-feed/1.0",
            }
        )
    ...
    def setup(self):
        self.create_consumer(topics=INPUT_TOPICS, group_id="dragon-scale-drl-feed")
