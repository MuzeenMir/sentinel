#!/usr/bin/env bash
# =============================================================================
# DRAGON_SCALE Platform — Development Install Script
# =============================================================================
...
if command -v docker &>/dev/null && docker info &>/dev/null; then
  ...
  # — build of dragon-scale services happens via 'docker compose build'
...
echo -e "${BOLD}${GREEN}║          DRAGON_SCALE — Setup Complete                  ║${NC}"
echo -e "${BOLD}${GREEN}╚══════════════════════════════════════════════════════╝${NC}"
echo ""
