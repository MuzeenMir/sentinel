# DRAGON_SCALE ML Model Architecture

This document describes the machine learning models, feature engineering pipeline, and training infrastructure used by the DRAGON_SCALE AI Engine and DRL Engine.
...
DRAGON_SCALE uses a multi-model ensemble architecture for threat detection, combined with a deep reinforcement learning agent for autonomous policy generation.
...
- `ppo_dragon_scale.zip` -- stable-baselines3 model checkpoint.
