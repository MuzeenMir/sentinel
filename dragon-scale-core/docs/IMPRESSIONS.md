...
This document is DRAGON_SCALE's analogue. Its job is to capture, in the voice of the people
who actually run the platform during a real incident, what DRAGON_SCALE feels like:
...
*This section is the "happy path" — moments where DRAGON_SCALE did something the team is
...
examples; DRAGON_SCALE's first release of this document does not have them yet, and we'd
...
*This section is for moments where DRAGON_SCALE was wrong — misclassifications,
...
section is that readers learn what DRAGON_SCALE looks like when it's wrong.*
...
but valid path. For DRAGON_SCALE, the likely instances are:*
...
1. **The detector ensemble is usually more confident than any individual detector.**
   ...
   DRAGON_SCALE the way they read 0.92 from a standalone detector.
