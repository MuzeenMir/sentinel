# DRAGON_SCALE Compliance Readiness

Preparation checklists and guidance for achieving compliance certifications relevant to DRAGON_SCALE as both a security product and a compliant software platform.
...
- [DRAGON_SCALE Internal Security Audit](#dragon-scale-internal-security-audit)
...
SOC 2 Type II assesses the operational effectiveness of controls over a review period (typically 6-12 months). DRAGON_SCALE targets the **Security**, **Availability**, and **Confidentiality** Trust Services Criteria.

### Security (Common Criteria)

| Control | Description | DRAGON_SCALE Implementation | Evidence Required |
|---------|-------------|-------------------------|-------------------|
...
ISO 27001 Annex A control mapping for DRAGON_SCALE.

### A.5 -- Information Security Policies

| Control | DRAGON_SCALE Mapping |
|---------|------------------|
| A.5.1 | `AGENTS.md` security principles; `.cursor/rules/dragon-scale-standards.mdc` coding standards |
...
## DRAGON_SCALE Internal Security Audit

Scope and methodology for auditing DRAGON_SCALE's own security posture.
...
- API Gateway: `https://dragon-scale.example.com:8080`
- Admin Console: `https://dragon-scale.example.com:3000`
