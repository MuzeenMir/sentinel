# DRAGON_SCALE — Console UX Workflow with Claude Design

| Field          | Value                                             |
|----------------|---------------------------------------------------|
| Document ID    | DRAGON_SCALE-DESIGN-001                               |
| Version        | 1.0.0                                             |
...
DRAGON_SCALE Admin Console across every phase of the v2 revamp. It pairs design
...
design files. DRAGON_SCALE has a real React app already; use it.
...
5. **Iconography** — the icon library in use (lucide / heroicons / etc.) and
   any custom SVGs.
6. **Voice and tone** — three short examples of how DRAGON_SCALE writes button
