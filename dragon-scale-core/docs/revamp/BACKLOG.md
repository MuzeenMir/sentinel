...
- [P0] governance — migrate CODEOWNERS entries from `@MuzeenMir` placeholder to org-scoped teams (`@MuzeenMir/dragon-scale-backend`, `…-frontend`, `…-security`, `…-infra`). Blocked on org team creation. (added 2026-04-19)
