...
class FeedbackCollector:
    ...
    def __init__(self, redis_client=None, min_samples_for_retrain: int = 100):
    ...
    def get_training_samples(self, min_confidence: float = 0.8) -> List[Dict[str, Any]]:
        """
