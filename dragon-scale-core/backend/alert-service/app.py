...
INTEGRATIONS_KEY = "dragon-scale:integrations"
...
Please investigate immediately.
            ...
            <body style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <p style="color: #666; font-size: 12px; margin-top: 20px;">
                    This is an automated notification from DRAGON_SCALE Security Platform.
                </p>
            </body>
            </html>
            """
                ...
                "attachments": [
                    {
                        ...
                        "footer": "DRAGON_SCALE Security Platform",
                    }
                ]
            }
...
def test_integration():
    ...
    test_event = {
        "type": "test",
        "severity": "low",
        "description": "DRAGON_SCALE integration connectivity test",
        "timestamp": time.time(),
        "source": "dragon-scale-test",
    }
