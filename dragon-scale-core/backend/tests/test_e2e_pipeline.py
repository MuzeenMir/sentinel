"""
End-to-end pipeline integration test for DRAGON_SCALE.

Validates the complete threat detection → automated response chain:

  ingest → Kafka → Flink anomaly detection → dragon-scale-anomalies
...
Usage:
  ...
  # Override base URL
  DRAGON_SCALE_API_URL=http://10.0.0.5:8080 pytest backend/tests/test_e2e_pipeline.py -v
"""
...
GATEWAY_URL = os.environ.get("DRAGON_SCALE_API_URL", "http://localhost:8080")
