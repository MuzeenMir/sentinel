/**
 * DRAGON_SCALE Full-Surface k6 Load Test
 *
...
const errorRate       = new Rate('dragon_scale_error_rate');
const authLatency     = new Trend('dragon_scale_auth_latency', true);
const threatLatency   = new Trend('dragon_scale_threat_latency', true);
const alertLatency    = new Trend('dragon_scale_alert_latency', true);
const policyLatency   = new Trend('dragon_scale_policy_latency', true);
const complianceLatency = new Trend('dragon_scale_compliance_latency', true);
const aiLatency       = new Trend('dragon_scale_ai_latency', true);
const drlLatency      = new Trend('dragon_scale_drl_latency', true);
const xaiLatency      = new Trend('dragon_scale_xai_latency', true);
const totalRequests   = new Counter('dragon_scale_total_requests');
...
export const options = {
  ...
  thresholds: {
    ...
    dragon_scale_error_rate:       ['rate<0.01'],
    dragon_scale_auth_latency:     ['p(95)<300'],
    dragon_scale_threat_latency:   ['p(95)<500'],
    dragon_scale_alert_latency:    ['p(95)<500'],
    dragon_scale_policy_latency:   ['p(95)<500'],
    dragon_scale_compliance_latency: ['p(95)<1000'],
    dragon_scale_ai_latency:       ['p(95)<500'],
    dragon_scale_drl_latency:      ['p(95)<300'],
    dragon_scale_xai_latency:      ['p(95)<1000'],
  },
};
