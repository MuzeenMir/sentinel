"""
Comprehensive pytest unit tests for the DRAGON_SCALE Data Collector.
...
class TestCIMNormalization:
    def test_normalize_api_data(self):
        ...
        assert result["vendor"] == "dragon-scale"
...
# ===================================================================
# SSE publish on threat detection (Redis publish to dragon-scale:sse:threats)
# ===================================================================


class TestSSEPublish:
    def test_publish_to_dragon_scale_sse_threats_on_anomaly(self, client):
        _fake_redis_publish_log.clear()
        payload = {
            "source_ip": "1.2.3.4",
            "dest_ip": "5.6.7.8",
        ...
        assert channel == "dragon-scale:sse:threats"
