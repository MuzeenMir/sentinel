...
// DRAGON_SCALE process execution monitor
...
int dragon_scale_process_exec(struct trace_event_raw_sched_process_exec *ctx)
{
    ...
    evt->event_type = DRAGON_SCALE_EVENT_PROCESS_EXEC;
