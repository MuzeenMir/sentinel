...
// DRAGON_SCALE network connect monitor
...
int dragon_scale_tcp_v4_connect_entry(struct pt_regs *ctx)
{
...
int dragon_scale_tcp_v4_connect_return(struct pt_regs *ctx)
{
    ...
    evt->event_type = DRAGON_SCALE_EVENT_NET_CONNECT;
