...
// DRAGON_SCALE XDP flow monitor -- packet inspection, per-flow accounting, blocklist enforcement
                                            ...
                                            struct flow_value *val)
{
    ...
    evt->event_type = DRAGON_SCALE_EVENT_NETWORK_FLOW;
...
SEC("xdp")
int dragon_scale_xdp_flow(struct xdp_md *ctx)
{
