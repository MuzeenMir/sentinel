...
logger = logging.getLogger("dragon-scale.ebpf.loader")
...
class SignatureVerifier:
    ...
    def __init__(self, key_path: Optional[str] = None):
        ...
        key_source = key_path or os.environ.get("DRAGON_SCALE_EBPF_SIGN_KEY")
...
class ProgramLoader:
    ...
    def __init__(
        ...
        self._compiled_dir = Path(
            compiled_dir
            or os.environ.get("DRAGON_SCALE_EBPF_COMPILED_DIR", "")
