...
SSE_CHANNEL_THREATS = "dragon-scale:sse:threats"
SSE_CHANNEL_ALERTS = "dragon-scale:sse:alerts"
STATS_CACHE_KEY = "dragon-scale:gateway:stats_cache"
STATS_CACHE_TTL = 10
...
# ---------------------------------------------------------------------------
CONFIG_CACHE_KEY = "dragon-scale:config"
