"""Shared resilience patterns for DRAGON_SCALE services: circuit breaker, retry, structured logging.
...
class JSONFormatter(logging.Formatter):
    ...
    def __init__(self, service_name: str = "dragon-scale"):
        super().__init__()
    ...
    def record_failure(self) -> None:
        with self._lock:
            ...
            if self._state == self.HALF_OPEN:
                ...
                self._state = self.OPEN
                logging.getLogger("dragon-scale.circuit_breaker").warning(
        ...
        def wrapper(*args, **kwargs):
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    logging.getLogger("dragon-scale.retry").warning(
