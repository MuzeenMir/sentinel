...
class PPOAgent:
    ...
    def __init__(
        ...
        state_dim: int,
        action_dim: int,
        model_path: str = "/tmp/ppo_dragon_scale",
        device: str = "auto",
    ):
    ...
    def save_model(self, path: Optional[str] = None) -> bool:
        ...
        Saves ``policy_net.pt``, ``value_net.pt``, ``ppo_dragon_scale.zip`` and
        ...
        try:
            ...
            self._model.save(os.path.join(save_dir, "ppo_dragon_scale"))
    ...
    def load_model(self, path: Optional[str] = None) -> bool:
        ...
        model_zip = os.path.join(load_dir, "ppo_dragon_scale.zip")
