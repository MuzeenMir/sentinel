"""Centralized SOC2 audit logger for DRAGON_SCALE services.
...
_AUDIT_KEY_PREFIX = "dragon-scale:audit:"
_AUDIT_INDEX = "dragon-scale:audit:index"
_AUDIT_STATS = "dragon-scale:audit:stats"
_AUDIT_TTL_DAYS = int(os.environ.get("AUDIT_RETENTION_DAYS", "365"))
_SERVICE_NAME = os.environ.get("DRAGON_SCALE_SERVICE_NAME", "unknown")
