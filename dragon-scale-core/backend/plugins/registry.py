"""Plugin registry for the DRAGON_SCALE backend.

Plugins extend DRAGON_SCALE at runtime — custom detectors, new compliance
...
Usage::
    ...
    registry.discover_plugins("/opt/dragon-scale/plugins")
...
logger = logging.getLogger("dragon-scale-plugins")


class Plugin(ABC):
    """Interface that every DRAGON_SCALE plugin must implement."""
