...
class FirewallRule:
    ...
    @classmethod
    def block_ip(
        cls, ip: str, duration_hours: int = 24, reason: str = ""
    ) -> "FirewallRule":
...
class FirewallAdapter(ABC):
    ...
    def clear_dragon_scale_rules(self) -> Dict[str, Any]:
        """
        Remove all DRAGON_SCALE-managed rules.
    ...
    def block_ip(
        self, ip: str, duration_hours: int = 24, reason: str = ""
    ) -> Dict[str, Any]:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "dragon_scale_rules": len([r for r in rules if r.created_by == "dragon-scale"]),
        }
