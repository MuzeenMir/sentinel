...
class PolicyEngine:
    ...
    def create_policy(
        ...
        Args:
            ...
            auto_applied: Whether this policy was auto-applied by the DRL pipeline
            source: Originating service (e.g. 'drl-engine')
        ...
        policy = {
            ...
            "applied_by": source or policy_data.get("created_by", "system"),
            "version": 1,
    ...
    def get_all_policies(self) -> List[Dict[str, Any]]:
        ...
        for key in self.redis.scan_iter(f"{self.POLICY_PREFIX}*"):
            if not key.startswith(self.VERSION_PREFIX):
    ...
    def update_policy(
        self, policy_id: str, policy_data: Dict[str, Any], rules: List[Dict]
    ) -> Dict[str, Any]:
