          ...
          <>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-400">{threat.type || 'network_anomaly'}</p>
              </div>
              <div className="flex gap-2 items-center">
                ...
                {threat.status && (
                  <span className="px-2 py-1 rounded text-xs font-medium bg-blue-900/50 text-blue-300 border border-blue-700 capitalize">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <pre className="text-xs bg-gray-900/80 border border-gray-700 rounded-lg p-3 overflow-auto max-h-64">
