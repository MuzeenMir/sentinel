...
export function Alerts() {
  ...
  const statCards = alertStats
    ? [
        { label: 'New', value: alertStats.new, color: 'text-blue-400', bg: 'bg-blue-500/10' },
        { label: 'Acknowledged', value: alertStats.acknowledged, color: 'text-yellow-400', bg: 'bg-yellow-500/10' },
        { label: 'Resolved', value: alertStats.resolved, color: 'text-green-400', bg: 'bg-green-500/10' },
        { label: 'Ignored', value: alertStats.ignored, color: 'text-slate-400', bg: 'bg-slate-500/10' },
      ]
    : null
              ...
              <tbody className="divide-y divide-slate-700/50">
                {alerts.map((alert) => (
                  <tr key={alert.id} className="hover:bg-slate-800/30">
                    ...
                    <td className="table-cell font-medium text-white">{alert.type}</td>
                    <td className="table-cell font-mono text-xs">{alert.source}</td>
                    <td className="table-cell max-w-xs truncate">{alert.description}</td>
