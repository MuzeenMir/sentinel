      ...
      <div className="card">
        ...
        <div className="card-body space-y-4">
          <div>
            ...
            <input type="text" defaultValue="SENTINEL Security" className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
        ...
        <div className="card-body space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Automatically apply DENY policy for critical threats</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Allow AI to make autonomous policy decisions</p>
            </div>
            <ToggleSwitch defaultChecked />
          </div>
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Current: 85%</p>
          </div>
        </div>
      </div>
        ...
        <div className="card-body space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Send email for critical threats</p>
            </div>
            <ToggleSwitch defaultChecked />
          </div>
          <div className="flex items-center justify-between">
